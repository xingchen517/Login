...
namespace Login
{
    ...
    public class HttpWebResponseUtility
    {
            ...
            int? timeout, string userAgent, Encoding requestEncoding, CookieCollection cookies)
        {
            ...
            request.Referer =
                @"http://172.16.96.100:8080/am/page/portal/realm/2e0d1ff9-c070-4e05-a07e-23325461e9db/login/pc/index.html?stage=2&revisit=false&language=en-US";
            if (!string.IsNullOrEmpty(userAgent))
            {
                request.UserAgent = userAgent;
            }
            ...
            //resp.Close();
            //var ck = request.CookieContainer; //保存cookies
